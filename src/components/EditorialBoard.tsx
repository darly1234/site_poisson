    ...
    <div className="mx-auto max-w-6xl px-6 pb-24">
      ...
      <div className="text-center max-w-3xl mx-auto mb-16">
        <h1 className="mt-3 font-display text-[clamp(2.5rem,6vw,4.5rem)] leading-[1.05] tracking-tight text-balance">
          Colegiado de <span className="serif text-orange-500 italic">Mestres</span> <span className="text-black">e</span> <span className="serif text-orange-500 italic">Doutores</span>
        </h1>
